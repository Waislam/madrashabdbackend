...
class StudentIncome(models.Model):
    ...
    updated_by = models.ForeignKey(User, on_delete=models.PROTECT, related_name='updated_st_icomes', blank=True,
    ...
    def generate_receipt_number(self):
        ...
        last_obj = StudentIncome.objects.filter(madrasha__slug=madrasha_slug).last()
        if last_obj:
        ...
        # new_receipt_number = madrasha_slug + year + new_number
...
class OtherIncome(models.Model):
    madrasha = models.ForeignKey(Madrasha, on_delete=models.PROTECT, related_name='other_incomes', blank=True,
                                 null=True)
    category = models.ForeignKey(IncomeCategory, on_delete=models.PROTECT, related_name='categories_others', blank=True,
                                 null=True)
    sub_category = models.ForeignKey(IncomeSubCategory, on_delete=models.PROTECT, related_name='sub_categories_others',
                                     blank=True, null=True)
    donar_name = models.CharField(max_length=200, null=True, blank=True)
    member = models.ForeignKey(PermanentMembers, on_delete=models.PROTECT, related_name='member_id', blank=True,
                               null=True)
    ...
    updated_at = models.DateTimeField(auto_now=True)
    updated_by = models.ForeignKey(User, on_delete=models.PROTECT, related_name='updated_other_incomes', blank=True,
                                   null=True, editable=False)
    voucher_name = models.CharField(max_length=50, blank=True)
    ...
    def generate_receipt_number(self):
        ...
        year = str(today_date.year)
        start_from = 1
        last_obj = OtherIncome.objects.filter(madrasha__slug=madrasha_slug).last()
        if last_obj:
            receipt_number = last_obj.receipt_number  # string value
            last_receipt_number = int(receipt_number[4:])
        else:
...
class AllExpense(models.Model):
    ...
    category = models.ForeignKey(ExpenseCategory, on_delete=models.PROTECT, related_name='expense_categories',
                                 null=True)
    sub_category = models.ForeignKey(ExpenseSubCategory, on_delete=models.PROTECT,
                                     related_name='expense_sub_categories', null=True)
    ...
    updated_at = models.DateTimeField(auto_now=True)
    updated_by = models.ForeignKey(User, on_delete=models.PROTECT, related_name='updated_expenses', blank=True,
                                   null=True, editable=False)
    voucher_name = models.CharField(max_length=50, blank=True)
